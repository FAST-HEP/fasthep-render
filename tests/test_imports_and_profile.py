...
def test_load_registry_profile_resource() -> None:
    ...
    assert "fasthep_render.impl.sinks.hist1d:run_hist1d_render" in text


def test_load_render_specs_and_impls() -> None:
    refs = [
        (
            "fasthep_render.spec.sinks.hist1d:HIST1D_RENDER_SPEC",
            "fasthep_render.impl.sinks.hist1d:run_hist1d_render",
        ),
        (
            "fasthep_render.spec.sinks.data_mc:DATA_MC_RENDER_SPEC",
            "fasthep_render.impl.sinks.data_mc:run_data_mc_render",
        ),
        (
            "fasthep_render.spec.sinks.heatmap2d:HEATMAP2D_RENDER_SPEC",
            "fasthep_render.impl.sinks.heatmap2d:run_heatmap2d_render",
        ),
        (
            "fasthep_render.spec.sinks.project:PROJECT_RENDER_SPEC",
            "fasthep_render.impl.sinks.project:run_project_render",
        ),
        (
            "fasthep_render.spec.sinks.comparison:COMPARISON_RENDER_SPEC",
            "fasthep_render.impl.sinks.comparison:run_comparison_render",
        ),
    ]
